...
const translations: Record<Language, Record<string, string>> = {
  en: {
    ...
    'workouts_ai.title': 'Tactical Protocol Generator',
    'workouts_ai.subtitle': 'Gemini-powered algorithmic training sequences.',
    'workouts_ai.prompt_placeholder': 'Describe your mission objectives (e.g., strength gain, fat loss, mobility)...',
    'workouts_ai.generate': 'Execute Generation',
    'workouts_ai.generating': 'Synthesizing Protocol...',
    'workouts_ai.history': 'Protocol Archives',

    'attendance.title': 'Live Attendance Grid',
    'attendance.subtitle': 'Active units currently synced to the facility.',
    'attendance.check_in': 'Unit Sync (Check-in)',
    'attendance.check_out': 'Sync Termination (Check-out)',
    'attendance.recent': 'Recent Sync Activity',
    
    'nav.community': 'Community',
    'nav.workouts_ai': 'Tactical AI',
  ...
  ar: {
    ...
    'workouts_ai.title': 'مولد البروتوكول التكتيكي',
    'workouts_ai.subtitle': 'تسلسلات تدريب خوارزمية مدعومة من Gemini.',
    'workouts_ai.prompt_placeholder': 'صف أهداف مهمتك (مثلاً: زيادة القوة، فقدان الدهون، المرونة)...',
    'workouts_ai.generate': 'تنفيذ التوليد',
    'workouts_ai.generating': 'توليف البروتوكول...',
    'workouts_ai.history': 'أرشيف البروتوكولات',

    'attendance.title': 'شبكة الحضور المباشر',
    'attendance.subtitle': 'الوحدات النشطة المتزامنة حالياً مع المنشأة.',
    'attendance.check_in': 'مزامنة الوحدة (دخول)',
    'attendance.check_out': 'إنهاء المزامنة (خروج)',
    'attendance.recent': 'نشاط المزامنة الأخير',

    'nav.community': 'المجتمع',
    'nav.workouts_ai': 'الذكاء التكتيكي',
